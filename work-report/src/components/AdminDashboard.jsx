                ...
                <div className="user-card-header" style={{display: 'flex', gap: '1.5rem', alignItems: 'center'}}>
                  ...
                  <div className="user-main-info" style={{marginTop: 0}}>
                    <div style={{display: 'flex', gap: '0.5rem', alignItems: 'center', flexWrap: 'wrap', marginBottom: '0.3rem'}}>
                      <span className="user-role-tag" style={{color: user.role === 'admin' ? 'var(--admin-accent)' : '#fff', margin: 0}}>
                        {user.role}
                      </span>
                      {user.photo && (user.photo.includes('googleusercontent.com') || user.photo.includes('google')) && (
                        <span className="google-badge" title="Google Account Connected" style={{
                          display: 'inline-flex',
                          alignItems: 'center',
                          gap: '4px',
                          ...
                          <svg viewBox="0 0 48 48" style={{width: '10px', height: '10px'}}>
